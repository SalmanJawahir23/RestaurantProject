...
if (file_exists('setup_completed.flag')) {
    // echo "<script>
    //         alert('Setup has already been completed. The SQL setup won't run again.');
    //         window.location.href = 'customerSide/home/home.php';
    //       </script>";
    header("Location: customerSide/home/home.php");
    exit();
    // echo "Setup has already been completed.";
    // echo "The SQL setup won't run again.";
} else {
    ...
    function executeSQLFromFile($filename, $link) {
        ...
        if ($link->multi_query($sql) === TRUE) {
            ...
            echo "<a href='customerSide/home/home.php'>Home</a>";
        } else {
