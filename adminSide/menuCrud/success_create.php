...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        $insert_query = "INSERT INTO Menu (item_id, item_name, item_type, item_category, item_price, item_description, item_image) 
                        VALUES (?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($insert_query);

        // Bind the parameters
        $stmt->bind_param("ssssdss", $item_id, $item_name, $item_type, $item_category, $item_price, $item_description, $item_image);
